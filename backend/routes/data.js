...
router.get('/bootstrap', (req,res) => {
  ...
  const grades=db.prepare('SELECT * FROM grades WHERE user_id=? ORDER BY date DESC,id DESC').all(uid);
  res.json({school,subjects,activities,grades});
});
